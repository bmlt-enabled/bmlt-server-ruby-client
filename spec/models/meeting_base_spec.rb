...
# Unit tests for BmltClient::MeetingBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BmltClient::MeetingBase do
  let(:instance) { BmltClient::MeetingBase.new }

  describe 'test an instance of MeetingBase' do
    it 'should create an instance of MeetingBase' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BmltClient::MeetingBase)
    end
  end
