...
module BmltClient
  class RootServerApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :force Force deletion of service body and all associated meetings (default to 'false')
    # @return [nil]
    ...
    def delete_service_body_with_http_info(service_body_id, opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'force'] && !allowable_values.include?(opts[:'force'])
    ...
    def get_settings_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RootServerApi.get_settings ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SettingsObject'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bmltToken']

      new_options = opts.merge(
        :operation => :"RootServerApi.get_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RootServerApi#get_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :skip_venue_type_location_validation specify true to skip venue type location validation
    # @return [nil]
    ...
    def patch_meeting_with_http_info(meeting_id, meeting_partial_update, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'skipVenueTypeLocationValidation'] = opts[:'skip_venue_type_location_validation'] if !opts[:'skip_venue_type_location_validation'].nil?
    ...
    # @param settings_update [SettingsUpdate] Pass in settings object with values to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_settings(settings_update, opts = {})
      update_settings_with_http_info(settings_update, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_settings_with_http_info(settings_update, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RootServerApi.update_settings ...'
      end
      # verify the required parameter 'settings_update' is set
      if @api_client.config.client_side_validation && settings_update.nil?
        fail ArgumentError, "Missing the required parameter 'settings_update' when calling RootServerApi.update_settings"
      end
      # resource path
      local_var_path = '/api/v1/settings'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(settings_update)
      ...
      new_options = opts.merge(
        :operation => :"RootServerApi.update_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RootServerApi#update_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
